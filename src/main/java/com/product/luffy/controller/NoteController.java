...
public class NoteController {
	...
	public @ResponseBody GridResponseObject<User> selectShareUserList(@PathVariable("noteId") String noteId) {
	...
	public @ResponseBody ResponseObject<Boolean> insertShareUser(@PathVariable("noteId") String noteId,
	...
	public @ResponseBody ResponseObject<Boolean> deleteShareUser(@PathVariable("noteId") String noteId,
	...
	public @ResponseBody GridResponseObject<Note> selectShareNoteList() {
		GridResponseObject<Note> gridResponseObject = new GridResponseObject<Note>();
	...
	public @ResponseBody ResponseObject<Boolean> deleteShareNote(@PathVariable("noteId") String noteId) {
		ResponseObject<Boolean> responseObject = new ResponseObject<Boolean>();
